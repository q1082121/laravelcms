...
class UserSeeder extends Seeder
{
    ...
    public function run()
    {
		...
		$userinfos = array(
		  ...
		  array('name' => NULL,'nick' => '子管理员','sex' => '0','birthday' => NULL,'qq' => NULL,'area_pid' => '0','area_cid' => '0','area_xid' => '0','score' => '0','money' => '0.00','user_id' => '2','created_at' => date("Y-m-d H:i:s"),'updated_at' => date("Y-m-d H:i:s")),
		  array('name' => NULL,'nick' => '小呆瓜','sex' => '0','birthday' => NULL,'qq' => NULL,'area_pid' => '0','area_cid' => '0','area_xid' => '0','score' => '0','money' => '0.00','user_id' => '3','created_at' => date("Y-m-d H:i:s"),'updated_at' => date("Y-m-d H:i:s"))
		);
