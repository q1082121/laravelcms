          ...
          <div class="box-body">
            <div class="form-group">
              <div class="input-group">
                <span class="input-group-addon minwidth">{{trans('admin.website_product_item_classid')}}</span>
            ...
            <div class="form-group">
              <div class="input-group">
                <span class="input-group-addon minwidth">{{trans('admin.website_product_item_title')}}</span>
                <input  type="text" class="form-control" v-model="params_data.title"   >
              </div>
            </div>
            <div class="form-group">
                <div class="input-group">
                  <span class="input-group-addon minwidth">{{trans('admin.website_product_item_introduction')}}</span>
                  <textarea  class="form-control" rows="3" v-model="params_data.introduction" > </textarea>
                </div>
            </div>
            <div class="form-group">
              <div class="input-group">
                <span class="input-group-addon minwidth">{{trans('admin.website_product_item_sources')}}</span>
            ...
            <div class="form-group">
                <div class="input-group">
                  <span class="input-group-addon minwidth">{{trans('admin.website_product_item_content')}}</span>
                  <div class="editor">
...
new Vue({
    ...
    methods: 
    {
      ...
      check_action:function(posturl)
      {
          ...
          {
              var msg="{{trans('admin.website_product_select')}}";
              layermsg_error(msg);
          }
          else if (this.params_data.title=='')
          {
              var msg="{{trans('admin.product_failure_tip1')}}";
              layermsg_error(msg);
          }
          else
          {
