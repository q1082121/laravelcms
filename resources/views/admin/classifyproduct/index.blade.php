      ...
      <div class="box" id="app-content">
        <div class="box-header">
          <h3 class="box-title">
            ...
            <i class="fa fa-add"></i> {{trans('admin.website_classifyproduct_create_cache')}}
            </button>
            @endability
          </h3>
        ...
        <div class="box-body" >
          <table class="table table-bordered">
            ...
            <tr>
              ...
              <th>{{trans('admin.website_classifyproduct_item_name')}}</th>
              <th>{{trans('admin.website_classifyproduct_item_attachment')}}</th>
              <th>{{trans('admin.website_classifyproduct_item_bcid')}}</th>
              <th>{{trans('admin.website_classifyproduct_item_scid')}}</th>
              <th>{{trans('admin.website_classifyproduct_item_navflag')}}</th>
              <th>{{trans('admin.website_classifyproduct_item_orderid')}}</th>
              <th>{{trans('admin.website_classifyproduct_item_status')}}</th>
