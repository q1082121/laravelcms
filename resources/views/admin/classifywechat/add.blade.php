          ...
          <div class="box-body">
            <div class="form-group">
              <div class="input-group">
                <span class="input-group-addon minwidth">{{trans('admin.website_classifywechat_item_topclass')}}</span>
            ...
            <div class="form-group">
              <div class="input-group">
                <span class="input-group-addon minwidth">{{trans('admin.website_classifywechat_item_type')}}</span>
            ...
            <div class="form-group">
              <div class="input-group">
                <span class="input-group-addon minwidth">{{trans('admin.website_classifywechat_item_name')}}</span>
                <input type="text" class="form-control" v-model="params_data.name"   >
              </div>
            </div>
            <div class="form-group">
              <div class="input-group">
                <span class="input-group-addon minwidth">{{trans('admin.website_classifywechat_item_keyword')}}</span>
                <input type="text" class="form-control" v-model="params_data.keyword"   >
              </div>
            </div>
            <div class="form-group">
              <div class="input-group">
                <span class="input-group-addon minwidth">{{trans('admin.website_classifywechat_item_ico')}}</span>
                <input type="text" class="form-control" v-model="params_data.ico"   >
              </div>
            </div>
            <div class="form-group">
              <div class="input-group">
                <span class="input-group-addon minwidth">{{trans('admin.website_classifywechat_item_linkurl')}}</span>
                <input type="text" class="form-control" v-model="params_data.linkurl"   >
              </div>
            </div>
            <div class="form-group">
              <div class="input-group">
                <span class="input-group-addon minwidth">{{trans('admin.website_classifywechat_item_orderid')}}</span>
                <input type="text" class="form-control" v-model="params_data.orderid"   >
              </div>  
            </div>
            <div class="form-group">
                <label >{{trans('admin.website_classifywechat_item_status')}}</label>
