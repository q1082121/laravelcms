        ...
        <div class="box-body" >
          <table class="table table-bordered">
            ...
            <tr>
              ...
              <th>{{trans('admin.website_log_item_type')}}</th>
              <th>{{trans('admin.website_log_item_name')}}</th>
              <th>{{trans('admin.website_log_item_info')}}</th>
              <th>{{trans('admin.website_log_item_ip')}}</th>
              <th>{{trans('admin.website_log_item_created_at')}}</th>
