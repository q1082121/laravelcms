    ...
    <div class="col-xs-12">
      <div class="box" id="app-content">
        <div class="box-header">
          <h3 class="box-title">
            <a href="{{ route('get.admin.navigation.add') }}" >
          ...
          <table class="table table-bordered">
            ...
            <tbody>
              <tr v-for="item in datalist">
                ...
                <td>
                  <i v-if="item.isattach == 1" onclick="open_box_image('/uploads/{{getCurrentControllerName()}}/thumb/@{{item.attachment}}')" class="fa fa-file-picture-o"> 查看 </i> <i v-else class="fa fa-file-o" ></i>
                </td>
                <td>@{{ item.bcid }}</td>
                <td>@{{ item.scid }}</td>
...
new Vue({
    el: '#app-content',
    data: {
             apiurl_list          :'{{ route("post.admin.navigation.api_list") }}',
             ...
             linkurl_edit         :'{{ route("get.admin.navigation.edit") }}/', 
             totals               : 0,
