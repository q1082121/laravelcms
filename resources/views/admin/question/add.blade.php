      ...
      <div class="box" id="app-content">
        ...
        <!-- /.box-header -->
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              <label >{{trans('admin.website_question_item_attachment')}}</label><br>
              <!--
            ...
            @if ($website['type'] == 3)
            <div class="form-group">
                <label >{{trans('admin.website_question_item_is_answer')}}</label>
            ...
            <div class="form-group">
                <label >{{trans('admin.website_question_item_status')}}</label>
...
new Vue({
    ...
    methods: 
    {
      ...
      check_action:function(posturl)
      {
          ...
          {
              var msg="{{trans('admin.website_question_select')}}";
              layermsg_error(msg);
          }
          else if (this.params_data.title=='')
          {
              var msg="{{trans('admin.question_failure_tip1')}}";
              layermsg_error(msg);
          }
          else
          {
