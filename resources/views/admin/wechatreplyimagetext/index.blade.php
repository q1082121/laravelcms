...
new Vue({
    ...
    data: {
             apiurl_list          :'{{ route("post.admin.wechatreplyimagetext.api_list") }}',
             linkurl_add          :'{{ route("get.admin.wechatreplyimagetext.add") }}/{{$website["wechat_id"]}}',
             linkurl_edit         :'{{ route("get.admin.wechatreplyimagetext.edit") }}/',
