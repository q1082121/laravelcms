        ...
        <div class="box-body" >
          <table class="table table-bordered">
            ...
            <tr>
              ...
              <th>{{trans('admin.fieldname_item_appid')}}</th>
              <th>{{trans('admin.fieldname_item_appsecret')}}</th>
...
new Vue({
    ...
    data: {
             apiurl_list          :'{{ route("post.admin.xcxmp.api_list") }}',
             apiurl_one_action    :'{{ route("post.admin.oneactionapi.api_one_action") }}',
             linkurl_add          :'{{ route("get.admin.xcxmp.add") }}',
             linkurl_edit         :'{{ route("get.admin.xcxmp.edit") }}/',
